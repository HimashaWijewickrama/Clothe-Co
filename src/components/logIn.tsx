...
export const LogIn: React.FC = () => {
    ...
    return (
        <Modal show={isView} onHide={handleClose} >
            <Modal.Header>
                <Modal.Title><p className="fs-5">Log In</p></Modal.Title>
            </Modal.Header>
                        ...
                        <div className="col-md-12">
                            <div className="card-body">
                                ...
                                <p className="card-text text-center" style={{ marginBottom: '5px' }}>
                                    Welcome 😊 you’ve been missed. Please enter your data to log in.</p><br />
                                <Formik
                                    initialValues={{
                                        firstname: 'James',
                                        lastname: 'Mark',
                                ...
                                >
                                    {props => (
                                        <form className="row g-3 needs-validation" onSubmit={props.handleSubmit}>
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <input className="form-control" id="validationCustom03"
                                                    type="text"
                                                    onChange={props.handleChange}
                                                    onBlur={props.handleBlur}
                                            ...
                                            <div className="col-md-12">
                                                <label htmlFor="validationCustom04" className="form-label">E mail Address *</label>
                                                <input className="form-control" id="validationCustom04"
                                                    type="text"
                                                    onChange={props.handleChange}
                                                    onBlur={props.handleBlur}
                                            ...
                                            <div className="col-md-12">
                                                ...
                                                <input className="form-control" id="validationCustom05"
                                                    type="text"
                                                    onChange={props.handleChange}
                                                    onBlur={props.handleBlur}
                                ...
                                <br />
                                <p className="card-text text-center"><small className="text-muted">Don't have an account? <Link to="/sign-up">Sign up</Link>
                                </small></p>
                            </div>
                        </div>
                    </div>
