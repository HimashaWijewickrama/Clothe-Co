...
const topColor3 = [
    ...
    { backgroundColor: '#E6C3B0' },
    { backgroundColor: '#D14D72' },

];
const topColor4 = [
    { backgroundColor: '#A69284' },
    { backgroundColor: '#E4D0D0' },
];
const topColor5 = [
    { backgroundColor: '#000000' },
    { backgroundColor: '#ffffff' },
    { backgroundColor: '#BDAAAC' },
...
const topColor11 = [
    { backgroundColor: '#B58F14' },
    { backgroundColor: '#197745' },
    { backgroundColor: '#963A2D' },

];
const topColor12 = [
    { backgroundColor: '#C4AEC3' },
